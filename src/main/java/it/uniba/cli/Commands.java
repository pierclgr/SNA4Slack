...
public class Commands {
	...
	public Commands() {
		...
		commands.add(new Command("mentions","-ch \"channelName\" -from \"memberName\" -f \"fileName\"","Get all mentions in \"channelName\" channel from \"memberName\" member from \"fileName\" zip file"));
	}
